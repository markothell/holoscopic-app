              ...
              {getSortedComments().map((comment) => {
                return (
                  <div
                    ...
                    className={`p-3 rounded-lg border-l-4 border border-[var(--border-subtle)] transition-all duration-200 bg-[var(--bg-secondary)] ${selectedCommentId === comment.id ? 'ring-2 ring-[#C83B50]' : ''}`}
