...
// In-memory embedding-index store (utils/unisonIndex.js's data-access shape)
...
// In-memory positional store (utils/unisonSynthesis.js's positionalMongoStore
...
// In-memory cache store (utils/unisonSynthesis.js's cacheMongoStore shape).
...
// ── citation assembly (relocated from unisonChat.js) ────────────────────
