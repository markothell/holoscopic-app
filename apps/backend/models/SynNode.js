...
const contentSchema = {
  ...
  // A thought is text and only text. D20 gave one a recording; it was pulled
  // on 2026-08-17 as complication the app did not need. Documents written
  // while it existed keep an `audio` subdocument in MongoDB — undeclared here,
  // so it is simply never read.
};
