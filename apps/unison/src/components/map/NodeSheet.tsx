...
import type { UnisonFrame, UnisonNode } from '@/lib/types';
      ...
      <div className="pb-2">
        ...
        <div className="mt-5 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Button variant="own" onClick={onAddChild}>
              {isTopic ? '+ Add thought' : '+ Add child'}
            </Button>
            <Button variant="synthesis" onClick={onStartMarry}>Marry from here</Button>
          </div>
        </div>
      </div>
    </Sheet>
