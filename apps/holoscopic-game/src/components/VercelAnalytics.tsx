...
// enabled — today chorus and holoscopic-game. It sits alongside Beacon.tsx and
// answers a different question: Vercel measures the *edge* (who arrived, from
// where, on what), our beacon measures the *platform* (which of seven products,
// on permanent counters we own). Neither replaces the other.
//
