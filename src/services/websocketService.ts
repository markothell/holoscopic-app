...
import { WeAllExplainActivity, WebSocketEvents, Rating, Comment, Participant } from '@/models/Activity';
...
export class WebSocketService {
  ...
  private setupEventListeners(): void {
    ...
    // Activity updates
    this.socket.on('activity_updated', (data: { activity: WeAllExplainActivity }) => {
