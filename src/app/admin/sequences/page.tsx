...
function SequenceAdminContent() {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [editingSequenceId, isAuthenticated]);
          ...
          <form onSubmit={handlePasswordSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
                placeholder="Enter admin password"
                autoFocus
              />
            </div>

            {authError && <div className="mb-4 text-red-400 text-sm">{authError}</div>}
